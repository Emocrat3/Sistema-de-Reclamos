...
const appRoutes: Routes = [
    ...
    {path:'editar-cuenta-ejecutivo/:rut', component:EditarCuentaEjecutivoComponent, canActivate: [AuthGuard]},
    ...
    {path:'busquedareclamoejecutivo', component:BusquedareclamoejecutivoComponent, canActivate: [AuthGuard]},
